...
async function initializeFaceModels() {
  ...
  await tf.ready();
  await faceapi.nets.ssdMobilenetv1.loadFromDisk('/nets2120/nets-project/basic-face-match/model');
  optionsSSDMobileNet = new faceapi.SsdMobilenetv1Options({ minConfidence: 0.5, maxResults: 1 });
  await faceapi.nets.faceLandmark68Net.loadFromDisk('/nets2120/nets-project/basic-face-match/model');
  await faceapi.nets.faceRecognitionNet.loadFromDisk('/nets2120/nets-project/basic-face-match/model');
...
//           const search = '/nets2120/nets-project/basic-face-match/query.jpg';
